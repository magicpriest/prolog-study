...
:- http_handler(root(algebra),             say_hi,                         []).
...
say_hi(_Request) :-         % (3)
        format('Content-type: text/plain~n~n'),
        format('
                ∟ Алгебра и геометрия &mdash; Шаг 1 (теор. подготовка) &mdash; теория (PDF, 1.2 mb): <a href="http://fizteh.org/files/upload/study/mathematics/algebra-geometry/theory.pdf">скачать</a>, смотреть;
                ∟ Алгебра и геометрия &mdash; Шаг 2 (практ. подготовка) &mdash;  практика (PDF, 1.1 mb): <a href="http://fizteh.org/files/upload/study/mathematics/algebra-geometry/practice.pdf">скачать</a>, смотреть;
                ∟ Алгебра и геометрия &mdash; Шаг 3 (домашнее задание), после завершения необходимо выслать на <a href="mailto:example@prepod.ru">электропочту преподавателя</a> &mdash;  ИДЗ (PDF, 0.3 mb): <a href="http://fizteh.org/files/upload/study/mathematics/algebra-geometry/homework.pdf">скачать</a>, смотреть;
                ∟ Алгебра и геометрия &mdash; Шаг 3 (индивидуальное домашнее задание), после завершения необходимо выслать на <a href="mailto:example@prepod.ru">электропочту преподавателя</a> &mdash; ИДЗ, набор кривых (DJVU, 1.2 mb): <a href="http://fizteh.org/files/upload/study/mathematics/algebra-geometry/curves.djvu">скачать</a>;
                ').
